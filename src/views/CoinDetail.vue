    ...
    methods: {
        ...
        getWebSite(exchange) {
            ...
            return api
                ...
                .then(res => {
                    this.$set(exchange, 'url', res.exchangeUrl) // Solucion al problema de reactividad
                    /*
                El problema de reactividad se origina por que vue no puede detectar si una propiedad existe 
                por que fue agregada despues que el objeto se creara y no esta siendo rastreada por vue
                */
                })
